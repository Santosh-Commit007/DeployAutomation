...
public class Shutdown_Wks_8 {
	private static String window = "W-11-21H2-ENG";

	@Test (description="Verify Shutdow wks as expected.")
	public void Shutdown() throws InterruptedException {
		...
		driver.findElement(
				...
				.click();
		Thread.sleep(5000);
		driver.findElement(By.xpath("//input[@onclick='openShutDownComputerConfirm();']")).click();
		
		Thread.sleep(5000);
		driver.findElement(By.xpath("//div[@id='dvConfirmCommonPopup']")).click();

...
public class InstalledAppusingApppreset_12 {
	private static String window = "W-11-21H2-ENG";
		...
		public void Shutdown() throws InterruptedException {
			...
			Thread.sleep(5000);
			driver.findElement(By.xpath("//a[normalize-space()='Manage App Presets']")).click();
			driver.findElement(By.xpath("driver.findElement(By.xpath(\"//a[@class='dropdown-item open-app-presets-popup-link']\"))")).click();

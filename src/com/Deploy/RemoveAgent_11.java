...
public class RemoveAgent_11 {
	private static String window = "W-11-21H2-ENG";

	@Test(description = "Verify RemoveAgent wks as expected.")
	public void Shutdown() throws InterruptedException {
		...
		driver.findElement(
				...
				.click();
		Thread.sleep(5000);
		driver.findElement(By.xpath("//input[@id='btnRemoveAgent']")).click();

		Thread.sleep(5000);
		driver.findElement(By.xpath("@id='btnConfirmCommonYes'")).click();
